            ...
            <div key={item.id}>
              <button
                ...
                style={{
                  ...
                  background: (active || childActive) ? "#faf0e6" : "transparent",
                  color: (active || childActive) ? "#C47A2C" : "#1e293b",
              ...
              >
                ...
                {hasChildren && (
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                    stroke={(active || childActive) ? "#C47A2C" : "#94a3b8"} strokeWidth="2"
                  ...
                  {item.children.map(child => {
                    ...
                    return (
                      <button key={child.id} onClick={() => setTab(child.id)} style={{
                        ...
                        background: cActive ? "#faf0e6" : "transparent",
                        color: cActive ? "#C47A2C" : "#334155",
                      ...
                      >
                        <span style={{ width: 4, height: 4, borderRadius: "50%", background: cActive ? "#C47A2C" : "#cbd5e1", flexShrink: 0 }} />
                        {child.label}
                      </button>
                    )
                  })}
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
          <main style={{ flex: 1, overflow: "auto", padding: 28 }}>
            ...
            <footer style={{ borderTop: "1px solid #e2e8f0", marginTop: 32, padding: "10px 0", fontSize: 11, color: "#94a3b8", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span>AIM Pronghorn 404 · Agency 2026</span>
            </footer>
          </main>
        </div>
      </div>
