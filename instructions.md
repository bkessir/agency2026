...
This hackathon requires building a solution for one of the challenges listed below. The database schema is available in the `Schema` folder. Participants will use modern AI tools and emerging agentic technologies to develop solutions to a live challenge focused on improving transparency, insights, and outcomes in government.
...
- **Schema files** are located in the `Schema/` folder:
  - `ab_schema.sql` – Alberta schema
  - `cra_schema.sql` – CRA T3010 schema
  - `fed_schema.sql` – Federal schema
  - `general_schema.sql` – General schema
  - `public_schema.sql` – Public schema
